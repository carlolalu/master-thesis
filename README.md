...
- remove difficult cyrillic variables (anything which is not ch and zhi)

- make a decent chapter 3 (take inspiration from a na and do it only for ht eamoebas, leave the camp out)

- notice: you are not able to make the correspondent of chapter 3 in chapter 7, because you did not make chapter 3 yet
