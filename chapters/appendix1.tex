\section{Space of solutions, formally}\label{app:formal-def-solution}
...
use chapter 2.4 from dudley to put a metrico n the function spaces for the hmactive processes, if necessary.
...
\begin{remark}
	...
	\begin{align*}
		...
		\}
	\end{align*}
	If we would be able to see $\{\star\} \sqcup \R^d$ as a space with some algebraic structure wehre $\star$ plays a special
	And the latter one, among the other things, a categorical construct on which one can put quite a lot of structure.
	This is useful in case we would like to inquire about properties about such spaces.
\end{remark}
