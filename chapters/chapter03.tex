...
This and the last problem can be solved by using a specific random measure.
To see how to define it let us first observe that

\begin{equation*}
definition of the COLLECTION btimes and the quivalent vector of poisson processes
\end{equation*}
