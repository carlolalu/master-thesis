...
Taking these as spawning times and indicising the cAMP particles consequently, we can imagine that each $\camp^m$ (the cAMP spawning at $\btime_m$) is spawned at its birth time with uniform probability on the position of one of the amoebas.
...
Assume that $\Parentof(m) \sim \Unf_{\{1,\ldots,N\}}$.
